            ...
            >
              <li class="nav-item">
                <a
                  ...
                  aria-selected="true"
                  ><i class="uil uil-book-alt"></i>My Courses</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-selected="false"
                  ><i class="uil uil-download-alt"></i>My Purchases</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-selected="false"
                  ><i class="uil uil-upload-alt"></i>Upcoming Courses</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-selected="false"
                  ><i class="uil uil-tag-alt"></i>Discounts</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-selected="false"
                  ><i class="uil uil-megaphone"></i>Promotions</a
                >
              </li>
            </ul>
                  ...
                  <table class="table ucp-table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <b class="course_active">Active</b>
                        </td>
                        <td class="text-center">
                  ...
                  <table class="table ucp-table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <b class="course_active">Download</b>
                        </td>
                        <td class="text-center">$15</td>
                        <td class="text-center">25 March 2020</td>
                        <td class="text-center">
                          <a href="#" title="Download" class="gray-s"
                            ><i class="uil uil-download-alt"></i
                          ></a>
                          <a href="#" title="Delete" class="gray-s"
                            ><i class="uil uil-trash-alt"></i
                          ></a>
                          <a href="#" title="Print" class="gray-s"
                  ...
                  <table class="table ucp-table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <b class="course_active">Pending</b>
                        </td>
                        <td class="text-center">
                          <a href="#" title="Edit" class="gray-s"
                            ><i class="uil uil-edit-alt"></i
